  ...
  try {
    ...
    if (result.specification && typeof result.specification === "object") {
      ...
      result.specification = spec;
        ...
        if (result.ingredientMeta && typeof result.ingredientMeta === "object") {
        const ingredientMeta = { ...result.ingredientMeta };

        // Translate sectionTitle
        if (
          ingredientMeta.sectionTitle &&
          typeof ingredientMeta.sectionTitle === "string" &&
          ingredientMeta.sectionTitle.trim()
        ) {
          ingredientMeta.sectionTitle =
            await translationService.translateI18nString(
              ingredientMeta.sectionTitle
            );
        }
        ...
        if (
          ...
          typeof ingredientMeta.sectionSubtitle === "string" &&
          ingredientMeta.sectionSubtitle.trim()
        ) {
          ingredientMeta.sectionSubtitle =
            await translationService.translateI18nString(
              ingredientMeta.sectionSubtitle
        ...
        // Translate excipients
        if (
          ingredientMeta.excipients &&
          typeof ingredientMeta.excipients === "string" &&
          ingredientMeta.excipients.trim()
        ) {
          ingredientMeta.excipients =
            await translationService.translateI18nString(
              ingredientMeta.excipients
        ...
        result.ingredientMeta = ingredientMeta;
      }
