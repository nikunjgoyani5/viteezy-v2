...
export const transformProductForLanguage = (
  ...
  // Transform ingredientMeta
  let transformedIngredientMeta = product.ingredientMeta;
  if (product.ingredientMeta) {
    transformedIngredientMeta = {
      ...product.ingredientMeta,
      sectionTitle: product.ingredientMeta.sectionTitle
        ? getTranslatedString(product.ingredientMeta.sectionTitle, lang)
        : undefined,
      sectionSubtitle: product.ingredientMeta.sectionSubtitle
        ? getTranslatedString(product.ingredientMeta.sectionSubtitle, lang)
        : undefined,
      backgroundImage: product.ingredientMeta.backgroundImage,
      excipients: product.ingredientMeta.excipients
        ? getTranslatedString(product.ingredientMeta.excipients, lang)
        : undefined,
    };
  }
  ...
  return {
    ...
    ingredientMeta: transformedIngredientMeta,
...
export async function enrichProduct(
  ...
  let enrichedProduct: any = {
    ...
    ingredientMeta: productWithMonthlyAmounts.ingredientMeta,
